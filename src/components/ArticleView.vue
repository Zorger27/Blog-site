...
<template>
  <el-row type="flex" justify="center" :class="viewMode ? '' : 'block-el-row'">
    <el-col :xs="23" :sm="22" :md="20" :lg="viewMode ? 18 : 22" :xl="viewMode ? 18 : 22" class="post-view"
      ...
      <el-row type="flex" justify="center" :class="viewMode ? 'post-sub-title' : 'post-sub-title-block'">
        ...
        <el-col :span="viewMode ? 5 : 24">
          Added: <strong>{{ item.author }}</strong>
        </el-col>
        <el-col :span="viewMode ? 5 : 24">
          {{ item.postTime }}
        </el-col>
...
<!--          <img src={{item.image}} alt="post picture"/>-->
      ...
      <el-row type="flex" justify="center">
        <el-col class="post-control" :span="12">
          <el-button @click="viewMore(item.id, item)">More</el-button>
        </el-col>
      </el-row>
    </el-col>
  </el-row>
